...
class Get_A_Quote_Public
{
    ...
    public function quote_form_fields()
    {
        ...
        if ('on' === $is_gaq_enable_plugin && '' !== $data ) {
            include_once plugin_dir_path(dirname(__FILE__)) . 'public/partials/get-a-quote-public-display.php';
        } else {
            return '';
        }
    }
    ...
    // {
    //     load_template('partials/get-a-quote-loader.php', true, $args = array());
    //     // wc_get_template(
