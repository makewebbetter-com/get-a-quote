 ...
 */
function mwb_gaq_get_country_states($country = '')
{
	if (empty($country)) {
		$country = 'US';
	}
	switch ($country) {
		case 'US':
			$states = mwb_gaq_get_states_list();
			break;
		case 'AO':
			$states = mwb_gaq_get_angola_provinces_list();
			break;
		case 'CA':
			$states = mwb_gaq_get_provinces_list();
			break;
		case 'AU':
			$states = mwb_gaq_get_australian_states_list();
			break;
		case 'BD':
			$states = mwb_gaq_get_bangladeshi_states_list();
			break;
		case 'BG':
			$states = mwb_gaq_get_bulgarian_states_list();
			break;
		case 'BR':
			$states = mwb_gaq_get_brazil_states_list();
			break;
		case 'CN':
			$states = mwb_gaq_get_chinese_states_list();
			break;
		case 'GB':
			$states = mwb_gaq_get_united_kingdom_states_list();
			break;
		case 'HK':
			$states = mwb_gaq_get_hong_kong_states_list();
			break;
		case 'HU':
			$states = mwb_gaq_get_hungary_states_list();
			break;
		case 'ID':
			$states = mwb_gaq_get_indonesian_states_list();
			break;
		case 'IN':
			$states = mwb_gaq_get_indian_states_list();
			break;
		case 'IR':
			$states = mwb_gaq_get_iranian_states_list();
			break;
		case 'IT':
			$states = mwb_gaq_get_italian_states_list();
			break;
		case 'JP':
			$states = mwb_gaq_get_japanese_states_list();
			break;
		case 'MX':
			$states = mwb_gaq_get_mexican_states_list();
			break;
		case 'MY':
			$states = mwb_gaq_get_malaysian_states_list();
			break;
		case 'NP':
			$states = mwb_gaq_get_nepalese_states_list();
			break;
		case 'NZ':
			$states = mwb_gaq_get_new_zealand_states_list();
			break;
		case 'PE':
			$states = mwb_gaq_get_peruvian_states_list();
			break;
		case 'TH':
			$states = mwb_gaq_get_thailand_states_list();
			break;
		case 'TR':
			$states = mwb_gaq_get_turkey_states_list();
			break;
		case 'ZA':
			$states = mwb_gaq_get_south_african_states_list();
			break;
		case 'ES':
			$states = mwb_gaq_get_spain_states_list();
			break;
		default:
			$states = array();
			break;
	}
	return apply_filters('mwb_gaq_states', $states, $country);
}
 ...
 */
function mwb_gaq_get_country_list()
{
	$countries = array(
		'' => '',
		'US' => 'United States',
	...
	return apply_filters('mwb_gaq_countries', $countries);
}
 ...
 * @return      array
 */
function mwb_gaq_get_states_list()
{
	$states = array(
		'' => '',
		'AL' => 'Alabama',
 ...
 */
function mwb_gaq_get_angola_provinces_list()
{
	$provinces = array(
		'' => '',
		'BGO' => 'Bengo',
 ...
 * @return      array
 */
function mwb_gaq_get_provinces_list()
{
	$provinces = array(
		'' => '',
		'AB' => 'Alberta',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_australian_states_list()
{
	$states = array(
		'' => '',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_bangladeshi_states_list()
{
	$states = array(
		'' => '',
		'BAG' => 'Bagerhat',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_brazil_states_list()
{
	$states = array(
		'' => '',
		'AC' => 'Acre',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_bulgarian_states_list()
{
	$states = array(
		'' => '',
		'BG-01' => 'Blagoevgrad',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_hong_kong_states_list()
{
	$states = array(
		'' => '',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_hungary_states_list()
{
	$states = array(
		'' => '',
		'BK' => 'Bács-Kiskun',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_japanese_states_list()
{
	$states = array(
		'' => '',
		'JP01' => 'Hokkaido',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_chinese_states_list()
{
	$states = array(
		'' => '',
		'CN1' => 'Yunnan / &#20113;&#21335;',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_united_kingdom_states_list()
{
	$states = array(
		'' => '',
	...
	return apply_filters('mwb_gaq_united_kingdom_states', $states);
}
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_new_zealand_states_list()
{
	$states = array(
		'' => '',
		'AK' => 'Auckland',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_peruvian_states_list()
{
	$states = array(
		'' => '',
		'CAL' => 'El Callao',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_indonesian_states_list()
{
	$states = array(
		'' => '',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_indian_states_list()
{
	$states = array(
		'' => '',
		'AP' => 'Andhra Pradesh',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_iranian_states_list()
{
	$states = array(
		'' => '',
		'KHZ' => 'Khuzestan',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_italian_states_list()
{
	$states = array(
		'' => '',
		'AG' => 'Agrigento',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_malaysian_states_list()
{
	$states = array(
		'' => '',
		'JHR' => 'Johor',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_mexican_states_list()
{
	$states = array(
		'' => '',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_nepalese_states_list()
{
	$states = array(
		'' => '',
		'ILL' => 'Illam',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_south_african_states_list()
{
	$states = array(
		'' => '',
		'EC' => 'Eastern Cape',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_thailand_states_list()
{
	$states = array(
		'' => '',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_turkey_states_list()
{
	$states = array(
		'' => '',
		'TR01' => 'Adana',
 ...
 * @return array $states A list of states
 */
function mwb_gaq_get_spain_states_list()
{
	$states = array(
		'' => '',
		...
		'A' => __('Alicante', 'mwb_gaq-plugins'),
		'AL' => __('Almer&iacute;a', 'mwb_gaq-plugins'),
		'O' => __('Asturias', 'mwb_gaq-plugins'),
		'AV' => __('&Aacute;vila', 'mwb_gaq-plugins'),
		'BA' => __('Badajoz', 'mwb_gaq-plugins'),
		'PM' => __('Baleares', 'mwb_gaq-plugins'),
		'B' => __('Barcelona', 'mwb_gaq-plugins'),
		'BU' => __('Burgos', 'mwb_gaq-plugins'),
		'CC' => __('C&aacute;ceres', 'mwb_gaq-plugins'),
		'CA' => __('C&aacute;diz', 'mwb_gaq-plugins'),
		'S' => __('Cantabria', 'mwb_gaq-plugins'),
		'CS' => __('Castell&oacute;n', 'mwb_gaq-plugins'),
		'CE' => __('Ceuta', 'mwb_gaq-plugins'),
		'CR' => __('Ciudad Real', 'mwb_gaq-plugins'),
		'CO' => __('C&oacute;rdoba', 'mwb_gaq-plugins'),
		'CU' => __('Cuenca', 'mwb_gaq-plugins'),
		'GI' => __('Girona', 'mwb_gaq-plugins'),
		'GR' => __('Granada', 'mwb_gaq-plugins'),
		'GU' => __('Guadalajara', 'mwb_gaq-plugins'),
		'SS' => __('Gipuzkoa', 'mwb_gaq-plugins'),
		'H' => __('Huelva', 'mwb_gaq-plugins'),
		'HU' => __('Huesca', 'mwb_gaq-plugins'),
		'J' => __('Ja&eacute;n', 'mwb_gaq-plugins'),
		'LO' => __('La Rioja', 'mwb_gaq-plugins'),
		'GC' => __('Las Palmas', 'mwb_gaq-plugins'),
		'LE' => __('Le&oacute;n', 'mwb_gaq-plugins'),
		'L' => __('Lleida', 'mwb_gaq-plugins'),
		'LU' => __('Lugo', 'mwb_gaq-plugins'),
		'M' => __('Madrid', 'mwb_gaq-plugins'),
		'MA' => __('M&aacute;laga', 'mwb_gaq-plugins'),
		'ML' => __('Melilla', 'mwb_gaq-plugins'),
		'MU' => __('Murcia', 'mwb_gaq-plugins'),
		'NA' => __('Navarra', 'mwb_gaq-plugins'),
		'OR' => __('Ourense', 'mwb_gaq-plugins'),
		'P' => __('Palencia', 'mwb_gaq-plugins'),
		'PO' => __('Pontevedra', 'mwb_gaq-plugins'),
		'SA' => __('Salamanca', 'mwb_gaq-plugins'),
		'TF' => __('Santa Cruz de Tenerife', 'mwb_gaq-plugins'),
		'SG' => __('Segovia', 'mwb_gaq-plugins'),
		'SE' => __('Sevilla', 'mwb_gaq-plugins'),
		'SO' => __('Soria', 'mwb_gaq-plugins'),
		'T' => __('Tarragona', 'mwb_gaq-plugins'),
		'TE' => __('Teruel', 'mwb_gaq-plugins'),
		'TO' => __('Toledo', 'mwb_gaq-plugins'),
		'V' => __('Valencia', 'mwb_gaq-plugins'),
...
function mwb_gaq_get_all_states()
{
	$countries = array('AO', 'CA', 'AU', 'BD', 'BG', 'BR', 'CN', 'GB', 'HK', 'HU', 'ID', 'IN', 'IR', 'IT', 'JP', 'MX', 'MY', 'NP', 'NZ', 'PE', 'TH', 'TR', 'ZA', 'ES');
	$states = mwb_gaq_get_country_states('US');
	foreach ($countries as $mycountry) {
		$states = $states + mwb_gaq_get_country_states($mycountry);
	}
	return apply_filters('mwb_gaq_all_states', $states);
}
add_action('wp_ajax_mwb_gaq_get_ajax_states', 'mwb_gaq_get_ajax_states');
add_action('wp_ajax_nopriv_mwb_gaq_get_ajax_states', 'mwb_gaq_get_ajax_states');
function mwb_gaq_get_ajax_states()
{
	$country = '';
	if (!empty($_GET['country'])) {
		$country = sanitize_text_field($_GET['country']);
	}
	$options = mwb_gaq_get_country_states($country);
	$resp = '';
...
function mwb_gaq_get_country_label($co)
{
	$countries = mwb_gaq_get_country_list();
	if (!empty($countries[$co])) {
		return $countries[$co];
	}
	return $co;
}
function mwb_gaq_get_state_label($co, $st)
{
	$states = mwb_gaq_get_country_states($co);
	if (!empty($states[$st])) {
		return $states[$st];
	}
	return $st;
