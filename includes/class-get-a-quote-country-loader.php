...
class GAQCountryManager {
	...
	public function country_states( $country = 'US' ) {
		...
		switch ( $country ) {
			case 'US':
				$states = $this->united_states_list();
				break;
			case 'AO':
				$states = $this->angola_provinces_list();
				break;
			case 'CA':
				$states = $this->provinces_list();
				break;
			case 'AU':
				$states = $this->australian_states_list();
				break;
			case 'BD':
				$states = $this->bangladeshi_states_list();
				break;
			case 'BG':
				$states = $this->bulgarian_states_list();
				break;
			case 'BR':
				$states = $this->brazil_states_list();
				break;
			case 'CN':
				$states = $this->chinese_states_list();
				break;
			case 'GB':
				$states = $this->united_kingdom_states_list();
				break;
			case 'HK':
				$states = $this->hong_kong_states_list();
				break;
			case 'HU':
				$states = $this->hungary_states_list();
				break;
			case 'ID':
				$states = $this->indonesian_states_list();
				break;
			case 'IN':
				$states = $this->indian_states_list();
				break;
			case 'IR':
				$states = $this->iranian_states_list();
				break;
			case 'IT':
				$states = $this->italian_states_list();
				break;
			case 'JP':
				$states = $this->japanese_states_list();
				break;
			case 'MX':
				$states = $this->mexican_states_list();
				break;
			case 'MY':
				$states = $this->malaysian_states_list();
				break;
			case 'NP':
				$states = $this->nepalese_states_list();
				break;
			case 'NZ':
				$states = $this->new_zealand_states_list();
				break;
			case 'PE':
				$states = $this->peruvian_states_list();
				break;
			case 'TH':
				$states = $this->thailand_states_list();
				break;
			case 'TR':
				$states = $this->turkey_states_list();
				break;
			case 'ZA':
				$states = $this->south_african_states_list();
				break;
			case 'ES':
				$states = $this->spain_states_list();
				break;
			default:
				$states = false;
				break;
