...
class Get_A_Quote
{
    ...
    private function get_a_quote_dependencies()
    {
         ...
         * core plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-get-a-quote-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-get-a-quote-i18n.php';

        if (is_admin() ) {

            // The class responsible for defining all actions that occur in the admin area.
            include_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-get-a-quote-admin.php';
            /**
             * The class responsible for defining all actions that occur in the onboarding the site data
             * in the admin side of the site.
             */
            ! class_exists('Makewebbetter_Onboarding_Helper') && include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-makewebbetter-onboarding-helper.php';
            $this->onboard = new Makewebbetter_Onboarding_Helper();

        } else {

            // The class responsible for defining all actions that occur in the public-facing side of the site.
            include_once plugin_dir_path(dirname(__FILE__)) . 'public/class-get-a-quote-public.php';

        }

        // The class is responsible for the common hooks used between admin and public area.
        include_once plugin_dir_path(dirname(__FILE__)) . 'common/class-get-a-quote-common.php';

        // The class responsible for defining all helper function to manipulate with requests and data.
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-get-a-quote-helper.php';

        // This class is responsible for the country-data-managing.
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-gaq-country-manager.php';
        ...
        if (is_array($gaq_components) && ! empty($gaq_components) ) {
            foreach ( $gaq_components as $gaq_component ) {
                ...
                case 'text':
                    ...
                    <div class="mwb-form-group mwb-gaq-<?php echo esc_attr($gaq_component['type']); ?>">
                        <div class="mwb-form-group__label">
                            <label for="<?php echo esc_attr($gaq_component['id']); ?>" class="mwb-form-label"><?php echo esc_html($gaq_component['title']); // WPCS: XSS ok. ?>
                            <a aria-hidden="true" class="mdc-text-field-helper-text--persistent mwb-helper-text" title="<?php echo esc_attr($gaq_component['description']); ?>"><i class="fa fa-question-circle" ></i></a></label></div>
                ...
                case 'textarea':
                    ...
                    <div class="mwb-form-group">
                        <div class="mwb-form-group__label">
                            <label class="mwb-form-label" for="<?php echo esc_attr($gaq_component['id']); ?>"><?php echo esc_attr($gaq_component['title']); ?>
                            <a aria-hidden="true" class="mdc-text-field-helper-text--persistent mwb-helper-text" title="<?php echo esc_attr($gaq_component['description']); ?>"><i class="fa fa-question-circle" ></i></a></label></div>
                        <div class="mwb-form-group__control">
                ...
                case 'multiselect':
                    ...
                    <div class="mwb-form-group <?php echo ( isset($gaq_component['wrap-class']) ? esc_attr($gaq_component['wrap-class']) : '' ); ?> ">
                        <div class="mwb-form-group__label ">
                            <label class="mwb-form-label" for="<?php echo esc_attr($gaq_component['id']); ?>"><?php echo esc_html($gaq_component['title']); ?>
                            <a aria-hidden="true" class="mdc-text-field-helper-text--persistent mwb-helper-text" title="<?php echo esc_attr($gaq_component['description']); ?>"><i class="fa fa-question-circle" ></i></a></label>
                        </div>
                        <div class="mwb-form-group__control">
                ...
                case 'checkbox':
                    ...
                    <div class="mwb-form-group">
                        <div class="mwb-form-group__label">
                            <label for="<?php echo esc_attr($gaq_component['id']); ?>" class="mwb-form-label"><?php echo esc_html($gaq_component['title']); ?>
                            <a aria-hidden="true" class="mdc-text-field-helper-text--persistent mwb-helper-text" title="<?php echo esc_attr($gaq_component['description']); ?>"><i class="fa fa-question-circle" ></i></a></label>
                        </div>
                ...
                case 'radio-switch':
                    ...
                    <div class="mwb-form-group">
                        <div class="mwb-form-group__label">
                            <label for="" class="mwb-form-label"><?php echo esc_html($gaq_component['title']); ?> 
                            <a aria-hidden="true" class="mdc-text-field-helper-text--persistent mwb-helper-text" title="<?php echo esc_attr($gaq_component['description']); ?>"><i class="fa fa-question-circle" ></i></a> </label>
                        </div>
                        <div class="mwb-form-group__control">
                            <div>
