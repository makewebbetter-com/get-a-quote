    ...
    <div class="wp-tooltip-label">
        <div class="mwb_gaq_email_sett_table">
            <table class="form-table mwb_gaq_email_setting">
                <tbody>
                    <?php if (isset($mwb_gaq_activate_email)) { ?>
                    <tr valign="top">
                        ...
                        <td>
                            <label class="mwb_gaq_enable_email">
                                ...
                                <?php
                                if (isset($mwb_gaq_activate_email['mwb_gaq_enable_email_setting'])) {
                                    echo ('on' === $mwb_gaq_activate_email['mwb_gaq_enable_email_setting']) ? "checked='checked'" : '';
                                }?>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <label class="mwb_gaq_email_subject">
                                <input id="emailsub" type="text" name="email_subject" value="<?php
                                echo (isset($mwb_gaq_activate_email['email_subject']) ? esc_html($mwb_gaq_activate_email['email_subject']) : '');
                                ?>">
                            </label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="mwb_gaq_email_message">
                                <textarea name="emailmess" rows="3" cols="30" ><?php
                                echo (isset($mwb_gaq_activate_email['emailmess']) ? esc_html($mwb_gaq_activate_email['emailmess']) : '');
                                ?></textarea>
                            </label>
                        </td>
                    </tr>
