	...
	<div class="mwb_gaq_container">
		<div id="mwb_gaq__form" class="mwb_gaq__form">
			<form method="post" class="form-group-fields">
				<div id="form-group-sname" class="form-group">
					<label for="name">Name*<i id="sname" class="fas fa-trash-alt icon_del"></i></label>
					<input id="name" type="text" required="required" placeholder="Enter your name" class="form-control">
				</div>
				<div id="form-group-semail" class="form-group">
					<label for="email">Email*<i id="semail"class="fas fa-trash-alt icon_del"></i></label>
					<input id="email" type="email" name="email" required="required" placeholder="Enter Your email" class="form-control">
				</div>
				<div id="form-group-smessage" class="form-group">
					<label for="message">Message<i id="smessage" class="fas fa-trash-alt icon_del"></i></label>
					<textarea id="message" name="message" rows="3" class="form-control"></textarea>
				</div>

				<button class="mwb_gaq__form__submit btn btn-info">Submit</button>
			</form>
		</div>
		<div id="mwb_gaq_commonFields" class="mwb_gaq__commonFields">
			...
			<div class="mwb_gaq_commonFields_group mwb_form_first_name" data-ftype="input" data-type="text" data-name="ffname" data-id="fname" data-placeholder="First Name" data-size="40" data-class="form-control" data-required="required" data-scope="sfirstname" data-label="First Name" >
				<div id="mwb_gaq_commonFields_icon" ><span id='icon_span' class="fas fa-file-signature"></span></div>
				First name
			</div>
			<div class="mwb_gaq_commonFields_group mwb_form_city" data-ftype="input" data-type="text" data-name="fcityname" data-id="city" data-placeholder="City name here" data-size="40" data-class="form-control" data-scope="scityname" data-label="City">
				<div id="mwb_gaq_commonFields_icon" ><span id='icon_span' class="fas fa-search-location"></span></div>
				City
			</div>
			<div class="mwb_gaq_commonFields_group mwb_form_email" data-ftype="input" data-type="email" data-name="email" data-id="email" data-placeholder="Email here" data-size="40" data-class="form-control" data-scope="ssemail" data-label="Email">
			...
			<div class="mwb_gaq_commonFields_group mwb_form_zipcode" data-inputmode="numeric" data-pattern="^(?(^00000(|-0000))|(\d{5}(|-\d{4})))$" data-placeholder="Zipcode here" data-ftype="input" data-type="text" data-name="zipcode" data-id="zipcodes" data-class="form-control" data-scope="szipcode" data-label="Zipcode">
			...
			<div class="mwb_gaq_commonFields_group mwb_form_budget" data-ftype="input" data-type="number" data-name="fbudget" data-placeholder="Budget" data-id="fbudget" data-class="form-control" data-scope="sbudget" data-label="Budget">
				...
				Budget	
			</div><div class="mwb_gaq_commonFields_group mwb_form_phone" data-ftype="input" data-type="tel" data-name="phone" data-placeholder="123-45-67-890" data-pattern="[0-9]{3}-[0-9]{2}-[0-9]{2}-[0-9]{3}" data-id="phone" data-class="form-control" data-scope="sphone" data-label="Phone Number">
