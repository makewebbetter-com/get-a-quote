...
$country = Get_A_Quote_Helper::mwb_gaq_get_country_list();
...
?>
<form
	action=" <?php plugin_dir_url(__FILE__) . 'class-get-a-quote-admin.php' ?>"
	...
	<table class="form-table">
		...
		<tr>
			<th><?php esc_html_e('Type of Service', 'get-a-quote'); ?><span
			...
			<td><input id="service" type="text" name="service" required="required"
				...
				<input id="Status" type="hidden" name="quote_status" required="required"
					value="<?php echo esc_html(!empty($details['quote_status']) ? $details['quote_status'] : ''); ?>"
					<?php echo esc_html(!empty($details['quote_status']) ? 'readonly' : ''); ?>>
			</td>
		</tr>

		<tr>
			<th><?php esc_html_e('First Name', 'get-a-quote'); ?><span
					class="required">*</span></th>
		...
		<tr>
			<th><?php esc_html_e('Last Name', 'get-a-quote'); ?><span
					class="required">*</span></th>
		...
		<tr>
			<th><?php esc_html_e('Address', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('City', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Zipcode', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Email', 'get-a-quote'); ?><span
					class="required">*</span></th>
		...
		<tr>
			<th><?php esc_html_e('Country', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('States', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Phone', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Budget', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Additional Details', 'get-a-quote'); ?>
			</th>
		...
		<tr>
			<th><?php esc_html_e('Attached File', 'get-a-quote');
                $log = ABSPATH . "wp-content/uploads/quote-submimwb_gaq_custom_meta_boxssion"; //echo '<pre>'; print_r( $log ); echo '</pre>';
                ?>
			</th>
			<td><b><Span><?php echo(!empty($details['fqfilename']) ? $details['fqfilename'] . ' <a href="opendir(' . $log . ')">Open Folder Location</a>' : '<input type="file" name="fqfiles" id="fileToUpload">'); ?></span></b>
			</td>
		</tr>
	</table>
</form>