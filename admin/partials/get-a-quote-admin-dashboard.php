...
<header>
	<div class="mwb-header-container mwb-bg-white mwb-r-8">
		...
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=get_a_quote_menu' ) . '&gaq_tab=' . esc_attr( 'get-a-quote-support' ) ); ?>" class="mwb-link"><?php esc_html_e( 'Support', 'get-a-quote' ); ?></a>
	</div>
</header>
